...
var React = __webpack_require__(4);
var Note = __webpack_require__(28);
var NoteForm = __webpack_require__(29);
    ...
    _createClass(List, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                'div',
                null,
                React.createElement(NoteForm, { addNote: this.add.bind(this) }),
                this.state.mang.map(function (e, i) {
                    return React.createElement(
                        Note,
                        { key: i, remove: _this2.del.bind(_this2), index: i },
                        e
                    );
                })
            );
